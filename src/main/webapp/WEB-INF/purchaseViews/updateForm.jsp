...
<table><caption>구매처 등록</caption>
	...
	<tr><th>사업자 번호</th><td><input type="text" name="seller_reg_num" value="${board.seller_reg_num}"/></td></tr>
	<tr><th>업체명</th><td><input type="text" name="seller_name" value="${board.seller_name}"/></td></tr>
	<tr><th>전화</th>	<td><input type="tel" name="seller_tel" value="${board.seller_tel}"/></td></tr>
	<tr><th>주소</th><td><input type="text" name="seller_address" value="${board.seller_address}"/></td></tr>
	<tr><th>담당자</th><td>${board.emp_no}</td></tr>
	<tr><th>이메일</th><td><input type="email" name="seller_email" value="${board.seller_email}"/></td></tr>
	<tr><th>참고사항</th><td><input type="text" name="seller_memo" value="${board.seller_memo}"/></td></tr>
