		...
		<div class="body">
			...
			<div class="content">
				...
				<div class="content_body">
					<form action="/project/sales/customerInsert.do" method="post" name="frm" onsubmit="return submitChk()">
					<table>
						<tr>
							<th>업체번호</th>
							<td>${customer_no}<input type="hidden" name="customer_no" required="required" value="${customer_no}" /></td>
						</tr>
						<tr>
							<th>업체명</th>
						...
						<tr class="addrRow">
							...
							<td>
								<div>
									<input type="text" name="customer_addr_no" id="postcode" required="required" placeholder="우편번호" />
									<input type="button" value="우편번호 입력" onclick="DaumPostcode()">
								</div>
								<div><input type="text" name="customer_addr" id="address" required="required" placeholder="주소"/></div>
								<div><input type="text" name="customer_addr_detail" id="detailAddress" required="required" placeholder="상세주소"/></div>
							</td>
						</tr>
						<tr>
							<th>담당자</th>
