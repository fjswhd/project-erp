...
<link href="/project/css/inventory/list.css?3" rel="stylesheet" type="text/css">
		...
		<div class="body">
			...
			<div class="content">
				...
				<div class="content_body">
					<form method="post" name="search" action="/project/inventory/enterSearchList.do">
						<div class="searchBox">
					...
					<table>
						...
						<c:if test="${empty searchList }">
							<tr>
								<th>검색 조건과 일치하는 입고 내역이 없습니다</th>
							</tr>
						</c:if>
						<c:if test="${not empty searchList }">
							<c:forEach var="purchase" items="${searchList}">
								<tr>
					...
					<c:url value="/inventory/enterSearchList.do" var="url">
