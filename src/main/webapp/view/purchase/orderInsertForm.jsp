...
<body>
	...
	<div id="body_container">
		...
		<!-- //판매주문일, 주문번호, 판매처코드, 판매처명, 상품코드, 상품명, 판매가, 매입가, 현재 재고량, 주문수량, 주문 등록 사원번호 -->			
						...
						<tr>
							<th>주문수량</th>
							<td><input type="number" name="purchase_detail_pcount" required="required" /></td>
						</tr>
						<tr>
							<th>재고량</th>
						...
						<tr>
							<th>구매 가능 수량</th>
							<td><input type="number" name="possible_pcount" required="required" readonly="readonly" value="0" /></td>
						</tr>
						<tr>
							<th>담당자</th>
							<td>
