			...
			<div class="content">
				...
				<div class="content_body">
					...
					<form method="post" name="search"
						action="/project/st/productListSearch.do">
						<div class="search">
							<div>
					...
					<div class="page">
						<a
							href="/project/st/productListSearch.do?pageNum=${startPage - 1}
							&searchField=${searchField}&keyword=${keyword}">&lt;</a>
						<c:forEach var="i" begin="${startPage}" end="${endPage}">
							<c:if test="${pageNum == i}">
								<b><a href="/project/st/productListSearch.do?pageNum=${i}
								&searchField=${searchField}&keyword=${keyword}'">${i }</a></b>
							</c:if>
							<c:if test="${pageNum != i}">
								<a href="/project/st/productListSearch.do?pageNum=${i}
								&searchField=${searchField}&keyword=${keyword}">${i}</a>
							</c:if>
						</c:forEach>
						<a href="/project/st/productListSearch.do?pageNum=${endPage + 1}
						&searchField=${searchField}&keyword=${keyword}">&gt;</a>
					</div>
