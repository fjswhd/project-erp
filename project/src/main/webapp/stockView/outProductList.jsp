		...
		<div class="body">
			...
			<div class="content">
				...
				<div class="content_body">
					...
					<div class="page">
						<a href="/project/st/outProductList.do?pageNum=${startPage - 1}">&lt;</a>
						<c:forEach var="i" begin="${startPage}" end="${endPage}">
							<c:if test="${pageNum == i}">
								<b><a href="/project/st/outProductList.do?pageNum=${i}'">${i }</a></b>
							</c:if>
							<c:if test="${pageNum != i}">							
								<a href="/project/st/outProductList.do?pageNum=${i}">${i}</a>
							</c:if>
						</c:forEach>
						<a href="/project/st/outProductList.do?pageNum=${endPage + 1}">&gt;</a>
					</div>
